...
/**
 * Based on https://anchor.host/using-github-to-self-host-updates-for-wordpress-plugins/
 */
class Updater
{
    ...
    public function __construct()
    {
        ...
        $this->version = MZTX_WP_PLUGIN_UPDATE_TEST_PLUGIN_VERSION;
    ...
    public function request(): mixed
    {
        ...
        if (false === $remote || !$this->cache_allowed) {
            $remote = wp_remote_get(MZTX_WP_PLUGIN_UPDATE_TEST_PLUGIN_MANIFEST_URL, [
                    'timeout' => 10,
                    'headers' => [
